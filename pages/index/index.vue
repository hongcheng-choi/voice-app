<template>
	<view class="container">
		...
		<view class="cate-section">
			...
			<view class="cate-item">
				<image src="/static/book/top1.png"></image>
				<text>排行</text>
			</view>
			<view class="cate-item">
				<image src="/static/book/list.png"></image>
				<text>阅读</text>
			</view>
			<view class="cate-item">
				<image src="/static/book/read.png"></image>
				<text>阅读</text>
			</view>
		</view>
		<!-- 模板一 -->
		<view class="seckill-section m-t">
			<view class="s-header">
				<text class="tip">模板一</text>
				<text class="yticon icon-you"></text>
			</view>
			<view class="s-content">
				<view class="s-content-top">
					aaa
				</view>
				<view class="s-content-top">
					bbb
